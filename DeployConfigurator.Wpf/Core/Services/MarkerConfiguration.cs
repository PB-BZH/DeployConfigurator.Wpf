...
╟────────────────────────────────────────────────────────────────────────────────║
║  Nom de fichier : MarkerConfiguration.cs												     
╚════════════════════════════════════════════════════════════════════════════════╝
*/
namespace DeployConfigurator.Wpf.Core.Services;

public class MarkerConfiguration {
  public string BootMarker { get; set; } = "BOOT_MARKER.txt";
  public string WindowsMarker { get; set; } = "WINDOWS_MARKER.txt";
  public string RecoveryMarker { get; set; } = "RECOVERY_MARKER.txt";
  public string Data1Marker { get; set; } = "DATA-1_MARKER.txt";
  public string Data2Marker { get; set; } = "DATA-2_MARKER.txt";
}